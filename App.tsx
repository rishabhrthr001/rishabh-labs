...
function App() {
  ...
  return (
    <div className="bg-dark text-slate-100 selection:bg-accent selection:text-black font-sans min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        {currentView.type === 'home' && (
            <>
                ...
                <Hero />
                <TechMarquee />
                <ServicesHorizontal onLearnMore={(id) => setCurrentView({ type: 'service', serviceId: id })} />
                <Projects />
                <Testimonials />
