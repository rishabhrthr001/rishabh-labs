...
const Hero: React.FC = () => {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 bg-dark">
      ...
      <div className="relative z-30 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pointer-events-none">
        ...
        >
          ...
          <span className="text-sm font-medium text-purple-200 tracking-wide">Forging the Next Generation</span>
        </motion.div>
        ...
        >
          Rishabh <br className="md:hidden" />
        ...
        >
          We engineer premium digital experiences. From high-scale web platforms to AI-driven automation, we turn visionary ideas into dominant realities.
        </motion.p>
        ...
        >
          ...
          >
            <span className="relative z-10 flex items-center gap-2">
              View Business Plans <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </span>
