            ...
            {BUSINESS_BUNDLES.map((currentPlan) => (
              <motion.div
                ...
                className="
                  w-[100vw]
                  sm:w-[95vw]
                  md:w-auto md:min-w-[720px]
                  lg:min-w-[900px]
                  snap-center relative z-20 flex-shrink-0
                "
              >
                <div
                  className={`relative rounded-[2.5rem] p-[1px] bg-gradient-to-r ${
                    currentPlan.popular
                      ? "from-orange-400 via-white to-rose-400"
                      : "from-purple-500/50 via-rose-500/50 to-purple-500/50"
                  }`}
                >
                  {currentPlan.popular && (
                  ...
                  <div className="relative bg-[#050505] rounded-[2.5rem] p-6 md:p-12 overflow-hidden h-full">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                      ...
                      <div className="w-full max-w-[400px] lg:w-[350px] flex-shrink-0 relative z-20 pointer-events-none">
                        ...
                        <div
                          className={`bg-white/5 border rounded-2xl p-6 md:p-8 backdrop-blur-md relative transform transition-transform duration-300
                           ${
                             currentPlan.popular
                               ? "border-accent/50 shadow-[0_0_30px_rgba(249,115,22,0.15)]"
                               : "border-white/10"
                           }
                        `}
                        >
                          ...
                          <div className="pb-6 border-b border-white/10 mb-6">
                            ...
                            <span className="text-xs text-accent font-mono mt-2 block uppercase tracking-wider">
                              One-time Investment
                            </span>
                          </div>
