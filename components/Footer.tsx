      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-2">
            <a 
              href="#hero" 
              onClick={(e) => { e.preventDefault(); onNavigate({ type: 'home' }); window.scrollTo(0,0); }}
            ...
            <p className="text-gray-400 max-w-sm mb-6">
              Empowering businesses with future-proof digital solutions. From simple websites to complex blockchain architectures.
            </p>
            <div className="flex gap-4">
              <a href="#" aria-label="Twitter" className="text-gray-400 hover:text-accent transition-colors"><Twitter className="w-5 h-5" /></a>
              <a href="#" aria-label="LinkedIn" className="text-gray-400 hover:text-accent transition-colors"><Linkedin className="w-5 h-5" /></a>
              <a href="#" aria-label="GitHub" className="text-gray-400 hover:text-accent transition-colors"><Github className="w-5 h-5" /></a>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <button 
                    onClick={() => onNavigate({ type: 'legal', pageId: 'privacy' })}
                    className="text-gray-400 hover:text-accent transition-colors text-sm"
                >
                    Privacy Policy
                </button>
              ...
              <li>
                <button 
                    onClick={() => onNavigate({ type: 'legal', pageId: 'cookie' })}
                    className="text-gray-400 hover:text-accent transition-colors text-sm"
                >
                    Cookie Policy
                </button>
