      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="mb-16">
            ...
            <h1 className="text-5xl md:text-7xl font-display font-bold text-white mb-6">
                About <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-rose-500">Rishabh Labs</span>
            </h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-24">
            {ABOUT_CONTENT.stats.map((stat, idx) => (
                <div key={idx} className="bg-surface/50 border border-white/10 rounded-2xl p-6 text-center backdrop-blur-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
            {ABOUT_CONTENT.values.map((value, idx) => (
                <div key={idx} className="bg-white/5 border border-white/5 rounded-3xl p-8 hover:bg-white/10 hover:border-purple-500/30 transition-all group">
        ...
        <div className="bg-gradient-to-r from-purple-900/40 to-rose-900/40 border border-white/10 rounded-3xl p-12 text-center relative overflow-hidden">
             ...
             <div className="relative z-10">
                ...
                <p className="text-gray-300 max-w-xl mx-auto mb-8">
                    Join the 50+ businesses that have transformed their digital presence with our expertise.
                </p>
                <button 
                    onClick={() => {
