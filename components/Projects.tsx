      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-6">
          <div className="max-w-2xl">
            ...
            >
              Forging <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-accent to-rose-500">Digital Reality</span>
            </motion.h2>
          </div>
          <motion.p 
          ...
          >
            We don't just write code; we engineer experiences that define brands and disrupt industries.
          </motion.p>
        </div>
              ...
              <div className="w-full md:w-3/5 group relative perspective-1000">
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-surface border border-white/10">
                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 flex items-center justify-center">
                    <a href={project.link} className="inline-flex items-center gap-2 px-6 py-3 bg-accent text-white rounded-full font-bold transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300 hover:scale-105 shadow-[0_0_20px_rgba(249,115,22,0.4)]">
                ...
                <div className="mb-8">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.techStack.map((tech) => (
                      <span key={tech} className="px-4 py-1.5 text-sm font-medium text-purple-300 bg-purple-900/20 rounded-full border border-purple-500/20">
                        {tech}
                      </span>
                    ))}
                  </div>
